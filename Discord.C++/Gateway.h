...
namespace DiscordCPP {
	...
	protected:
		...
		DLL_EXPORT virtual void on_websocket_incoming_message(const web::json::value& payload) = 0;
		DLL_EXPORT void on_websocket_disconnnect(const web::websockets::client::websocket_close_status& status, const std::string& reason, const std::error_code& error);
	public:
