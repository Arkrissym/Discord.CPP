...
pplx::task<void> DiscordCPP::VoiceClient::load_session_description(const value& data) {
...
DiscordCPP::VoiceClient::VoiceClient(MainGateway** main_ws, const string_t& voice_token, const string_t& endpoint, const string_t& session_id, const string_t& guild_id, const string_t& channel_id, const string_t& user_id) {
	_guild_id = guild_id;
